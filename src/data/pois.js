...
const bosses = new Category("bosses", [
	...
	new CircleItem("ghorm", "Ghorm the Devourer", [BIOMES.STONE, BIOMES.CLAY], [230], "#7F5F30", "#FFFFFF", true, "#", "bosses/ghorm.png"),
...
const pois = new Category("points_of_interest", [
	...
	new CircleItem("the_vault", "Glyph Parchment Treasury", [BIOMES.SUNKENSEA], [500], "#e4ad2a", "#FFFFFF", true, "#", "items/glyph_parchment.png"),
